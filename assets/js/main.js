...
const blurHeader = () =>{
    ...
    // Add a class if the bottom offset is greater than 50 of the viewport, add the blur-header class to the header tag
...
/* SCROLL SECTIONS ACTIVE LINK */  /* ASKKKK TEACHERRRR */
